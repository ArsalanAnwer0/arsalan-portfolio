...
const PS5Scene = () => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 3; i++) {
      put(
        g,
        bx(0.13, 0.17, 0.015, M.plastic([0x003366, 0x333333, 0x660022][i])),
        -0.55 + i * 0.04,
        0.12,
        -0.45,
      );
    ...
    put(
      g,
      bx(tW - tb * 2, tH - tb * 2, 0.018, M.screen(0x1a4a1a, 0x1a5a1a, 0.4)),
      0,
      0.44 + tH / 2,
      -0.58,
    );
    ...
    for (let i = 0; i < 3; i++) {
      ...
      put(
        g,
        bx(1.6, 0.012, 0.012, M.screen(crowdC, crowdC, 0.15), false, false),
        0,
        crowdY,
        -0.571,
      );
    ...
    for (let i = 0; i < 12; i++) {
      ...
      put(
        g,
        bx(1.55, 0.062, 0.012, M.screen(shade, shade, 0.2), false, false),
        0,
        0.555 + i * 0.065,
        -0.568,
      );
    ...
    for (let i = 0; i < circleSegs; i++) {
      ...
      put(
        g,
        bx(0.012, 0.012, 0.012, M.screen(0xffffff, 0xffffff, 0.5), false, false),
        Math.cos(a) * 0.13,
        0.94 + Math.sin(a) * 0.13,
        -0.565,
      );
    }
    // Center line + spot
    put(
      g,
      bx(0.015, 0.78, 0.012, M.screen(0xffffff, 0xffffff, 0.4), false, false),
      0,
      0.94,
      -0.565,
    );
    ...
    put(
      g,
      bx(1.52, 0.015, 0.012, M.screen(0xffffff, 0xffffff, 0.45), false, false),
      0,
      1.33,
      -0.565,
    );
    ...
    put(
      g,
      bx(0.015, 0.78, 0.012, M.screen(0xffffff, 0xffffff, 0.45), false, false),
      -0.76,
      0.94,
      -0.565,
    );
    ...
    [-0.76, 0.76].forEach((side) => {
      ...
      put(
        g,
        bx(0.015, 0.42, 0.012, M.screen(0xffffff, 0xffffff, 0.35), false, false),
        side,
        0.94,
        -0.565,
      );
      put(
        g,
        bx(0.24, 0.015, 0.012, M.screen(0xffffff, 0xffffff, 0.35), false, false),
        side - s * 0.12,
        1.15,
        -0.565,
      );
      ...
      put(
        g,
        bx(0.015, 0.24, 0.012, M.screen(0xffffff, 0xffffff, 0.35), false, false),
        side - s * 0.08,
        0.94,
        -0.565,
      );
      put(
        g,
        bx(0.08, 0.015, 0.012, M.screen(0xffffff, 0xffffff, 0.35), false, false),
        side - s * 0.04,
        1.06,
        -0.565,
      );
      ...
      put(
        g,
        sph(0.006, M.screen(0xffffff, 0xffffff, 0.6), 6, false, false),
        side - s * 0.16,
        0.94,
        -0.564,
      );
      ...
      for (let j = 0; j < 3; j++) {
        put(
          g,
          bx(0.005, 0.16, 0.012, M.screen(0xdddddd, 0xcccccc, 0.12), false, false),
          side + s * (0.01 + j * 0.008),
          0.94,
          -0.565,
        );
        put(
          g,
          bx(0.025, 0.005, 0.012, M.screen(0xdddddd, 0xcccccc, 0.12), false, false),
          side + s * 0.015,
          0.86 + j * 0.08,
          -0.565,
        );
    ...
    [
      ...
      for (let i = 0; i <= 5; i++) {
        ...
        put(
          g,
          bx(0.01, 0.01, 0.012, M.screen(0xffffff, 0xffffff, 0.35), false, false),
          cx + Math.cos(a) * 0.04 * sx,
          cy + Math.sin(a) * 0.04 * sy,
          -0.565,
        );
      }
    });
    ...
    const mkPlayer = (
      ...
      put(
        pg,
        bx(0.035, 0.01, 0.012, M.screen(0x0a3a0a, 0x0a3a0a, 0.18), false, false),
        0,
        -0.03,
        -0.564,
      );
      ...
      put(
        pg,
        bx(0.01, 0.008, 0.012, M.screen(0x111111, 0x111111, 0.35), false, false),
        -0.007,
        -0.028,
        -0.562,
      );
      ...
      put(
        pg,
        bx(0.008, 0.02, 0.012, M.screen(0xeebb88, 0xddaa77, 0.35), false, false),
        -0.007,
        -0.015,
        -0.562,
      );
      ...
      put(
        pg,
        bx(0.028, 0.035, 0.012, M.screen(jersey, jerseyE, 0.65), false, false),
        0,
        0.02,
        -0.562,
      );
      put(
        pg,
        bx(0.012, 0.012, 0.012, M.screen(0xffffff, 0xffffff, 0.25), false, false),
        0,
        0.025,
        -0.561,
      );
      ...
      put(
        pg,
        bx(0.006, 0.02, 0.012, M.screen(jersey, jerseyE, 0.5), false, false),
        -0.018,
        0.018,
        -0.562,
      );
      ...
      put(
        pg,
        bx(0.018, 0.007, 0.012, M.screen(0x221100, 0x221100, 0.25), false, false),
        0,
        0.053,
        -0.562,
      );
    ...
    const ball = put(
      g,
      sph(0.014, M.screen(0xffffff, 0xffffff, 1.0), 8, false, false),
      -0.05,
      0.92,
      -0.558,
    );
    const ballShadow = put(
      g,
      bx(0.018, 0.008, 0.012, M.screen(0x0a3a0a, 0x0a3a0a, 0.25), false, false),
      -0.05,
      0.905,
      -0.563,
    );
    ...
    put(
      g,
      bx(0.12, 0.045, 0.012, M.screen(0xdd2222, 0xcc1111, 0.6), false, false),
      -0.22,
      1.38,
      -0.562,
    );
    put(
      g,
      bx(0.05, 0.03, 0.012, M.screen(0xffffff, 0xffffff, 0.35), false, false),
      -0.17,
      1.38,
      -0.561,
    );
    ...
    put(
      g,
      bx(0.04, 0.045, 0.012, M.screen(0x1a1a1a, 0x0a0a0a, 0.5), false, false),
      -0.08,
      1.38,
      -0.562,
    );
    put(
      g,
      bx(0.018, 0.028, 0.012, M.screen(0xffffff, 0xffffff, 0.8), false, false),
      -0.08,
      1.38,
      -0.561,
    );
    ...
    put(
      g,
      bx(0.12, 0.045, 0.012, M.screen(0x2244dd, 0x1133cc, 0.6), false, false),
      0.12,
      1.38,
      -0.562,
    );
    ...
    put(
      g,
      bx(0.07, 0.035, 0.012, M.screen(0x1a1a1a, 0x0a0a0a, 0.45), false, false),
      0.27,
      1.38,
      -0.562,
    );
    put(
      g,
      bx(0.05, 0.02, 0.012, M.screen(0x44ff44, 0x33dd33, 0.55), false, false),
      0.27,
      1.38,
      -0.561,
    );
    ...
    put(
      g,
      bx(0.09, 0.03, 0.012, M.screen(0xffcc00, 0xffbb00, 0.5), false, false),
      -0.7,
      1.38,
      -0.562,
    );
    put(
      g,
      bx(0.04, 0.015, 0.012, M.screen(0x111111, 0x111111, 0.4), false, false),
      -0.7,
      1.38,
      -0.561,
    );
    ...
    put(
      g,
      bx(0.22, 0.11, 0.012, M.screen(0x0a3a0a, 0x0a3a0a, 0.35), false, false),
      0.6,
      0.56,
      -0.564,
    );
    put(
      g,
      bx(0.2, 0.095, 0.012, M.screen(0x1a7828, 0x167020, 0.22), false, false),
      0.6,
      0.56,
      -0.563,
    );
    ...
    put(
      g,
      bx(0.19, 0.001, 0.012, M.screen(0xffffff, 0xffffff, 0.15), false, false),
      0.6,
      0.56,
      -0.562,
    );
    put(
      g,
      bx(0.001, 0.085, 0.012, M.screen(0xffffff, 0xffffff, 0.15), false, false),
      0.6,
      0.56,
      -0.562,
    );
    ...
    [
      ...
      put(
        g,
        sph(0.004, M.screen(0xdd2222, 0xcc1111, 0.7), 4, false, false),
        0.6 + dx,
        0.56 + dy,
        -0.561,
      );
    ...
    [
      ...
      put(
        g,
        sph(0.004, M.screen(0x2244dd, 0x1133cc, 0.7), 4, false, false),
        0.6 + dx,
        0.56 + dy,
        -0.561,
      );
    ...
    const topLed = put(
      g,
      bx(1.5, 0.035, 0.015, M.glow(0x5533dd, 0x6644ee, 1.5), false, false),
      0,
      1.4,
      -0.68,
    );
    ...
    [-0.75, 0.75].forEach((x) => {
      const sideLed = put(
        g,
        bx(0.015, 0.9, 0.015, M.glow(0x5533dd, 0x6644ee, 1.2), false, false),
        x,
        0.95,
        -0.68,
      );
    ...
    p5L.position.set(-0.05, 0.23, -0.58);
    p5L.rotation.z = 0.06;
    g.add(p5L);
    const p5R = bx(0.15, 0.38, 0.14, M.plastic(0xeeeeea));
    p5R.position.set(0.05, 0.22, -0.58);
    p5R.rotation.z = -0.06;
    g.add(p5R);
    ...
    ps5Led.position.set(0, 0.22, -0.48);
    ps5Led.castShadow = false;
    g.add(ps5Led);
    ...
    put(
      g,
      bx(0.025, 0.008, 0.025, M.glow(0xff1111, 0xdd0000, 0.4), false, false),
      0.12,
      0.386,
      0.0,
    );
    ...
    put(
      g,
      bx(0.075, 0.005, 0.15, M.screen(0x112233, 0x112244, 0.2), false, false),
      0.15,
      0.382,
      0.38,
    );
    ...
    spareCtrl.position.set(-0.3, 0.385, 0.36);
    spareCtrl.rotation.y = 0.3;
    spareCtrl.castShadow = true;
    spareCtrl.receiveShadow = true;
    g.add(spareCtrl);
    [-0.08, 0.08].forEach((x) => {
      const grip = bx(0.05, 0.06, 0.06, M.plastic(0x151515));
      grip.position.set(-0.3 + x, 0.37, 0.4);
      grip.rotation.y = 0.3;
    ...
    put(g, cyl(0.08, 0.05, 0.1, M.fabric(0x555544)), -1.35, 0.79, 0.8);
    const lampBulb = put(
      g,
      sph(0.025, M.glow(0xffdd88, 0xffcc66, 0.6), 10, false, false),
      -1.35,
      0.76,
      0.8,
    );
    ...
    [
      ...
      put(
        controllerGroup,
        bx(0.022, 0.014, 0.022, M.plastic(0x8888cc), false, false),
        0.13 + dx,
        0.565,
        0.36 + dz,
      );
    ...
    put(
      controllerGroup,
      bx(0.04, 0.014, 0.08, M.plastic(0xccccc8), false, false),
      -0.13,
      0.565,
      0.36,
    );
    put(
      controllerGroup,
      bx(0.08, 0.014, 0.04, M.plastic(0xccccc8), false, false),
      -0.13,
      0.565,
      0.36,
    );
    [-0.07, 0.07].forEach((x) => {
      put(
        controllerGroup,
        bx(0.035, 0.018, 0.035, M.plastic(0x333333), false, false),
        x,
        0.568,
        0.42,
      );
    ...
    put(
      controllerGroup,
      bx(0.18, 0.01, 0.018, M.glow(0x0088ff, 0x0066cc, 1.2), false, false),
      0,
      0.565,
      0.26,
    );
    put(
      controllerGroup,
      bx(0.028, 0.016, 0.028, M.glow(0x4488ff, 0x2266dd, 0.5), false, false),
      0,
      0.565,
      0.44,
    );
    [-0.06, 0.06].forEach((x) => {
      put(
        controllerGroup,
        bx(0.025, 0.012, 0.015, M.plastic(0xbbbbbb), false, false),
        x,
        0.565,
        0.3,
      );
    ...
    [-0.15, 0.15].forEach((x) => {
      put(
        controllerGroup,
        bx(0.08, 0.015, 0.04, M.plastic(0xccccc8), false, false),
        x,
        0.575,
        0.28,
      );
    ...
    [-0.24, 0.24].forEach((x) => {
      ...
      put(
        controllerGroup,
        bx(0.08, 0.04, 0.06, M.skin(0xe0ac88), false, false),
        x * 0.7,
        0.5,
        0.38,
      );
    ...
    rBrow.position.set(0.075, 1.055, 0.555);
    rBrow.rotation.z = -0.08;
    rBrow.castShadow = false;
    rBrow.receiveShadow = false;
    head.add(rBrow);
    ...
    [-0.24, 0.24].forEach((x) => {
      ...
      cup.position.set(x, 1.0, 0.74);
      head.add(cup);
      const pad = cyl(0.06, 0.06, 0.05, M.fabric(0xaaaaaa), 12);
      pad.rotation.z = Math.PI / 2;
      pad.position.set(x, 1.0, 0.74);
      head.add(pad);
      const ring = cyl(0.065, 0.065, 0.018, M.metal(0xbbbbbb), 12, false, false);
      ring.rotation.z = Math.PI / 2;
      ring.position.set(x + (x > 0 ? 0.025 : -0.025), 1.0, 0.74);
      head.add(ring);
      put(
        head,
        sph(0.012, M.glow(0x22ccaa, 0x22ccaa, 0.9), 8, false, false),
        x + (x > 0 ? 0.038 : -0.038),
        1.0,
        0.69,
      );
    ...
    const animate = () => {
      ...
      // PS5 LED pulse
      (ps5Led.material as THREE.MeshStandardMaterial).emissiveIntensity =
        0.7 + Math.sin(t * 1.0) * 0.4;
      ...
      // Lamp glow flicker
      (lampBulb.material as THREE.MeshStandardMaterial).emissiveIntensity =
