...
export default function LoadingPage() {
  ...
  const bootSteps = [
    ...
    {
      text: "[    0.000000] Portfolio version 5.15.0-generic (buildd@arsalan-server)",
      delay: 40,
    },
    {
      text: "[    0.000000] Command line: BOOT_IMAGE=/boot/vmlinuz-5.15.0-generic root=/dev/sda1 ro quiet splash",
      delay: 40,
    },
    {
      text: "[    0.000000] microcode: microcode updated early to revision 0xea",
      delay: 30,
    },
    {
    ...
    {
      text: "[    0.000000] BIOS-e820: [mem 0x000000000009fc00-0x000000000009ffff] reserved",
      delay: 25,
    },
    {
      text: "[    0.000000] BIOS-e820: [mem 0x0000000000100000-0x000000007ffd8fff] usable",
      delay: 25,
    },
    {
    ...
    {
      text: "[    0.000000] DMI: Portfolio Systems WorkStation-Pro/Model-A1, BIOS 2.4",
      delay: 30,
    },
    ...
    {
      text: "[    0.300000] ACPI: RSDP 0x00000000000F6A10 000024 (v02 ARSALAN)",
      delay: 35,
    },
    {
      text: "[    0.400000] ACPI: XSDT 0x000000007FFE1131 00005C (v01 ARSALAN A M I)",
      delay: 35,
    },
    ...
    {
      status: true,
      text: "Starting Set the console keyboard layout...",
      delay: 50,
    },
    ...
    {
      status: true,
      text: "Starting Flush Journal to Persistent Storage...",
      delay: 50,
    },
    ...
    {
      status: true,
      text: "Starting Network Time Synchronization...",
      delay: 45,
    },
    ...
    {
      text: "Current Operating System: Arsalan Portfolio v5.15.0-generic # SMP PREEMPT_DYNAMIC",
      delay: 120,
    },
    {
      text: '[  +0.000] (==) Log file: "/home/arsalan/.local/share/xorg/Xorg.0.log"',
      delay: 150,
    },
    {
      text: '[  +0.001] (==) Using config directory: "/etc/portfolio/xorg.conf.d"',
      delay: 150,
    },
    {
      text: "[  +0.003] (II) modeset(0): Initializing display device...",
      delay: 180,
    },
    {
      text: "[  +0.120] (II) GLX: Initialized DRI2 GL provider for screen 0",
      delay: 200,
    },
    {
      text: "[  +0.200] (II) execve: launching /etc/portfolio/xinit/xinitrc → ~/.xinitrc",
      delay: 180,
    },
    {
      text: "[  +0.300] (--) ArsalanWM: Starting Arsalan Portfolio GUI...",
      delay: 200,
    },
  ...
  const renderStep = (step: any, index: number) => {
    ...
    if (step.text === "arsalan-portfolio login: ") {
      ...
      const isTypingUsername =
        currentStep === usernameStepIndex && nextStep?.isTyping;
    ...
    if (step.text === "Password: ") {
      ...
      const isTypingPassword =
        currentStep === passwordStepIndex && nextStep?.isTyping;
      ...
      return (
        <span>
          ...
          {hasTypedPassword && <span className="text-green-400">••••••••</span>}
        </span>
      );
    }
    ...
    if (step.text === "arsalan@portfolio:~$ ") {
      ...
      const isTypingCommand =
        currentStep === commandStepIndex && nextStep?.isTyping;
      ...
      return (
        <span className="text-green-400">
          ...
          {hasTypedCommand && <span className="text-white">startx</span>}
        </span>
      );
    }
