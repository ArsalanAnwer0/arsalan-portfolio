...
<div className="min-h-screen snap-y snap-mandatory overflow-y-scroll transition-all duration-1000 ease-in-out">
      ...
      <header className="bg-white dark:bg-black shadow sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <h1 className="text-xl md:text-2xl font-light tracking-wide dark:text-white text-gray-900">
            ARSALAN
          </h1>

          {/* Center - Location */}
          <h2 className="text-sm md:text-base dark:text-white text-gray-800">
            SAINT CLOUD, MINNESOTA
          </h2>

          {/* Right - Title */}
          <h3 className="text-sm md:text-base dark:text-white text-gray-800">
            CLOUD ENGINEER
          </h3>
        </div>
      </header>
...
/>
      ...
      <motion.section
        className="min-h-screen flex flex-col justify-center bg-white dark:bg-black snap-start"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
      ...
      >
        <div className="container mx-auto flex flex-col md:flex-row gap-10 items-center">
          ...
          >
            ...
            <p className="text-5xl md:text-6xl font-light leading-tight text-gray-900 dark:text-white">
              Arsalan is an aspiring cloud<br />
              engineer, pursuing his<br />
...
>
  ...
  {/* Timeline Container */}
  <div className="w-full max-w-5xl grid grid-cols-2 relative">
    
    {/* Left Side */}
    <div className="space-y-8 text-right pr-8">
      <div>
    ...
    {/* Bigger Timeline */}
    <div className="absolute left-1/2 transform -translate-x-1/2 w-[2px] h-[110%] bg-gray-500 rounded-lg"></div>
...
{/* Footer */}
<footer className="w-full py-6 bg-black text-white flex justify-center items-center border-t border-gray-700">
